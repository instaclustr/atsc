...
This repository is a Rust workspace containing ATSC (Advanced Time Series Compressor) and supporting crates. This file defines **how AI agents should work in this repo**: roles, boundaries, and project-specific guardrails (especially around on-disk formats and performance work).
